    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center ftco-vh-100">
        <div class="col-md-12">
          ...
          <h2 class="h5 ftco-subheading mb-5 ftco-animate">Best food in the city</h2>
          ...
          @foreach($promos as $promo)
            ...
            <div class="item">
              <div class="media d-block mb-4 text-center ftco-media ftco-animate border-0">
                <img src="{{$promo->image_url}}" alt="Free Template by Free-Template.co" class="img-fluid">
                <div class="media-body p-md-5 p-4">
                  <h5 class="text-primary">${{$promo->price}}</h5>
                  <h5 class="mt-0 h4">{{$promo->title}}</h5>
                  <p class="mb-4">{{str_limit($promo->description, 100)}}</p>
      ...
      <div class="row">
        ...
        <div class="col-md-12 text-center">
          ...
          <ul class="nav ftco-tab-nav nav-pills mb-5" id="pills-tab" role="tablist">
            @foreach ($mains as $main)
              ...
              <li class="nav-item ftco-animate">
                <a class="nav-link {{$mains->first() == $main ? 'active' : ''}}" id="pills-{{$main->title}}-tab" data-toggle="pill" href="#pills-{{$main->title}}" role="tab" aria-controls="pills-{{$main->title}}" aria-selected="false">{{$main->title}}</a>
              </li>
          ...
          <div class="tab-content text-left">
            ...
            <div class="tab-pane fade {{$mains->first() == $main ? 'show active' : ''}}" id="pills-{{$main->title}}" role="tabpanel" aria-labelledby="pills-{{$main->title}}-tab">
              <div class="row">
                ...
                <div class="col-md-6 ftco-animate">
                  ...
                  <div class="media menu-item">
                    ...
                    <div class="media-body">
                      ...
                      <p>{{str_limit($dish->description, 85)}}</p>
